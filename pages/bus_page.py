...
class BusPage(BasePage):
    ...
    BUS_MENU = (By.XPATH, "//a[@href='/buses/']")
    BOOK_NOW = (By.XPATH, "(//button[contains(text(),'Book Now')])[1]")

    SEAT_A2 = (By.XPATH, "//div[@data-seat-number='A2']")
    ADD_PASSENGERS_BTN = (By.XPATH, "//button[@type='submit' and contains(text(),'Add Passengers')]")
    ...
    def go_to_buses(self):
        self.wait_for_clickable(self.BUS_MENU)
        self.click(self.BUS_MENU)

    def select_bus(self):
        self.click(self.BOOK_NOW)

    def select_seat(self):
        self.click(self.SEAT_A2)

    def click_add_passengers(self):
        self.click(self.ADD_PASSENGERS_BTN)
